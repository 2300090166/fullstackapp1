pipeline {
    ...
    environment {
        ...
        TOMCAT_URL = 'http://51.20.75.157:9090/manager/text'
        TOMCAT_USER = 'admin'
        TOMCAT_PASS = 'admin'
    ...
    stages {
        stage('Clone Repository') {
            steps {
                git url: 'https://github.com/2300090166/fullstackapp1.git', branch: 'main'
            }
        }
    ...
    post {
        success {
            echo "✅ Backend deployed: http://51.20.75.157:9090/springapp1"
            echo "✅ Frontend deployed: http://51.20.75.157:9090/frontapp1"
        }
        failure {
